...
const Footer = () => {
    ...
    <h3 className={styles.main_footer_link_header}>Products</h3>
      <ul className={styles.main_footer_link_lists}>
        ...
        <li className={styles.main_footer_link_lists_item}>
          ...
          <a href="//www.android.com/enterprise/" className={styles.main_footer_link_each}>
    ...
    <li className={styles.main_footer_link}>
    <h3 className={styles.main_footer_link_header}>Use Cases</h3>
      <ul className={styles.main_footer_link_lists}>
        
        <li className={styles.main_footer_link_lists_item}>
          
          <a href="/games" className={styles.main_footer_link_each}>
        ...
        <li className={styles.main_footer_link_lists_item}>
          ...
          <a href="/ml" className={styles.main_footer_link_each}>
        ...
        <li className={styles.main_footer_link_lists_item}>
          ...
          <a href="/health_and_fitness" className={styles.main_footer_link_each}>
    ...
    <li className={styles.main_footer_link}>
    <h3 className={styles.main_footer_link_header}>Android Devices</h3>
      <ul className={styles.main_footer_link_lists}>
        
        <li className={styles.main_footer_link_lists_item}>
          
          <a href="/large_screens" className={styles.main_footer_link_each}>
        ...
        <li className={styles.main_footer_link_lists_item}>
          ...
          <a href="/wear" className={styles.main_footer_link_each}>
        ...
        <li className={styles.main_footer_link_lists_item}>
          ...
          <a href="/chrome_os" className={styles.main_footer_link_each}>
    ...
    <li className={styles.main_footer_link}>
    <h3 className={styles.main_footer_link_header}>About US</h3>
      <ul className={styles.main_footer_link_lists}>
    ...
    {/* <li className={styles.main_footer_link}>
    <h3 className={styles.main_footer_link_header}>Releases</h3>
      <ul className={styles.main_footer_link_lists}>
        
        <li className={styles.main_footer_link_lists_item}>
          
          <a href="/about/versions/14" className={styles.main_footer_link_each}>
        ...
        <li className={styles.main_footer_link_lists_item}>
          ...
          <a href="/about/versions/13" className={styles.main_footer_link_each}>
        ...
        <li className={styles.main_footer_link_lists_item}>
          ...
          <a href="/about/versions/12" className={styles.main_footer_link_each}>
    ...
    {/* <li className={styles.main_footer_link}>
    <h3 className={styles.main_footer_link_header}>Documentation and Downloads</h3>
      <ul className={styles.main_footer_link_lists}>
        
        <li className={styles.main_footer_link_lists_item}>
          
          <a href="/studio/intro" className={styles.main_footer_link_each}>
        ...
        <li className={styles.main_footer_link_lists_item}>
          ...
          <a href="/guide" className={styles.main_footer_link_each}>
    ...
    {/* <li className={styles.main_footer_link}>
    <h3 className={styles.main_footer_link_header}>Support</h3>
      <ul className={styles.main_footer_link_lists}>
        
        <li className={styles.main_footer_link_lists_item}>
          
          <a href="//issuetracker.google.com/issues/new?component=190923&amp;template=841312" className={styles.main_footer_link_each}>
        ...
        <li className={styles.main_footer_link_lists_item}>
          ...
          <a href="//issuetracker.google.com/issues/new?component=192697" className={styles.main_footer_link_each}>
            ...
            <ul className={styles.mava_copy}>
              <div className={styles.footer_first}>
                <li class={styles.mava_footer_link}>© 2024 mava</li>
                    <a href="">prvacy</a>
                    <a href="">Terms</a>
                    <a href="">Cookies</a>
              </div>
