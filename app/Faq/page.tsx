  ...
  const faqData = [
    {
      ...
      answer: 'The purpose of this FAQ is to provide a comprehensive guide for users to understand how to use our product/service.',
    },
    {
      question: 'How to translate Voice',
      answer: 'To reset your password, please follow these steps: [insert instructions here].',
    },
    {
