    ...
    return (
        <main className={styles.login_main}>
            ...
            <p className={styles.login_p}>Please Login</p>
            ...
            <a href="/forgot-password" className={styles.forgot_pass}>Forgot your password?</a>
            <input type="submit" value="Login" className={styles.login_btn_in}/>
            <p className={styles.or_}>Or login with an email</p>
            </div>
            ...
            <button className={styles.login_btn}>
                <svg height="25px" enable-background="new 0 0 512 512" fill="rgb(var(--black)" viewBox="0 0 512 512" width="25px" ><g id="_x37_8-microsoft"><g><g><path d="M270.912,241.049h223.691V31.708c0-8.26-6.68-14.958-14.914-14.958H270.912V241.049z      M270.912,241.049" fill="#5ACF5F;"/><path d="M241.09,241.049V16.75H32.313c-8.236,0-14.916,6.698-14.916,14.958v209.341H241.09z      M241.09,241.049" fill="#F84437;"/><path d="M241.09,270.953H17.397v209.343c0,8.251,6.68,14.954,14.916,14.954H241.09V270.953z      M241.09,270.953" fill="rgb(var(--black));"/><path d="M270.912,270.953V495.25h208.777c8.234,0,14.914-6.703,14.914-14.954V270.953H270.912z      M270.912,270.953" fill="rgb(var(--black));"/></g></g></g><g id="Layer_1"/></svg>
